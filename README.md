...
**o	vsFTPd 2.3.4 Backdoor (CVE-2011-2523):** Critical (CVSS 9.8) - Allows remote attackers to execute arbitrary code.

o	Samba usermap script Remote Command Execution (RCE (CVE-2007-2447)): Critical (CVSS 10.0) - Allows remote command execution.
o	Apache Tomcat 5.5: Critical - Multiple legacy exploits leading to information disclosure and RCE(Remote Code Execution).
o	MySQL Auth Bypass (CVE-2012-2122): High - Could allow attackers to bypass authentication.
